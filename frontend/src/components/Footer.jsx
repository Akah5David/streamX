...
export default function Footer() {
  return (
    <section className="w-full py-12 sm:py-14 lg:py-16 px-4 sm:px-6 md:px-8">
      <div className="mx-auto w-full max-w-[1200px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12 text-center sm:text-left items-start">
        <div className="flex flex-col items-center sm:items-start w-full">
        <div className="mb-[19px] gap-5 flex flex-col">
          <div className="flex gap-2 items-center min-w-max justify-center sm:justify-start">
            <img
              src={logoImg}
              alt="Logo"
              className="h-10 w-5 sm:h-12 sm:w-6 md:h-[60px] md:w-[30px]"
            />
            <h3 className="text-white font-bold font-serif text-xl sm:text-2xl md:text-[25px]">
              Streaming X
            </h3>
          </div>
        ...
        <div className="flex gap-4 flex-wrap w-full max-w-[240px] justify-center sm:justify-start">
          <div>
            <svg
              fill="currentColor"
              viewBox="0 0 32 32"
      ...
      <div className="flex flex-col gap-6 sm:gap-8 items-center sm:items-start w-full">
        <h3 className="mt-1 text-lg sm:text-xl font-bold">Pages(public)</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 w-full justify-items-center sm:justify-items-start text-sm sm:text-base">
          <Link to="/">Home</Link>
      ...
      <div className="flex flex-col gap-6 sm:gap-8 items-center sm:items-start w-full">
        <h3 className="mt-1 text-lg sm:text-xl font-bold">Pages(Membership)</h3>
        <div className="flex flex-col gap-4 sm:gap-6 items-center sm:items-start text-sm sm:text-base">
