  ...
  return (
    <>
      ...
      <main className="w-screen h-screen">
        <section className="flex flex-col gap-2 m ">
          <div className="relative w-full grid grid-cols-10  py-5 pr-8 pl-4">
            <div className="flex flex-col gap-10 col-span-5 row-1 rounded-2xl bg-[#3b38386b]  px-[15px] py-3">
              <div className="flex flex-col gap-5">
